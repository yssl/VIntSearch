...
*Search path* is the root directory of all sub-directories 1) that are searched by grep, 2) of which source files' symbols are contained in the tag file generated by **:VIntSearchBuildTag**, and 3) where the tag file is located.
